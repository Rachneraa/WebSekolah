    ...
    <div class="container">
        ...
        <div class="search-filter-section">
            ...
            <div class="filter-buttons" id="filterButtons">
                <div class="filter-item" data-filter="terbaru">
                    <span>Terbaru</span>
                </div>
                <div class="filter-item" data-filter="populer">
                    <span>Terpopuler</span>
                </div>
                <div class="filter-item" data-filter="berita">
                    <span>Berita</span>
                </div>
                <div class="filter-item" data-filter="artikel">
                    <span>Artikel</span>
                </div>
                <div class="filter-item" data-filter="kegiatan">
                    <span>Kegiatan</span>
                </div>
            </div>
        </div>
                ...
                <div class="artikel-grid" id="artikelGrid">
                    ...
                    <article class="artikel-card" data-category="prestasi">
                        ...
                        <div class="artikel-content">
                            ...
                            <a href="artikel-detail.php?id=1" class="artikel-link">Baca Selengkapnya <i
                    ...
                    <article class="artikel-card" data-category="kegiatan">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>Sekolah mengadakan workshop intensif pengembangan web modern dengan instruktur dari
                                perusahaan teknologi terkemuka. Workshop ini diikuti oleh siswa kelas XI dan XII jurusan
                                RPL.</p>
                            <a href="artikel-detail.php?id=2" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="kegiatan">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>Siswa kelas XII berkesempatan mengikuti program PKL di berbagai perusahaan teknologi
                                terkemuka di Indonesia. Program ini bertujuan memberikan pengalaman kerja nyata.</p>
                            <a href="artikel-detail.php?id=3" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="teknologi">
                        <div class="artikel-image">
                            ...
                            <img src="https://images.unsplash.com/photo-1488590528505-98d2b5aba04b?w=800"
                                alt="Lab Komputer">
                        </div>
                        <div class="artikel-content">
                            <div class="artikel-meta">
                            ...
                            <p>SMK TI Garuda Nusantara meresmikan laboratorium komputer baru yang dilengkapi dengan
                                perangkat keras dan software terbaru untuk mendukung pembelajaran siswa.</p>
                            <a href="artikel-detail.php?id=4" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="prestasi">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>Siswa SMK TI Garuda Nusantara berhasil meraih medali perak pada Olimpiade Sains Nasional
                                bidang Informatika yang digelar di Surabaya.</p>
                            <a href="artikel-detail.php?id=5" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="pengumuman">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>SMK TI Garuda Nusantara membuka pendaftaran siswa baru untuk tahun ajaran 2025/2026.
                                Daftar sekarang dan raih masa depan cemerlangmu di bidang teknologi.</p>
                            <a href="artikel-detail.php?id=6" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="kegiatan">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>Siswa berprestasi SMK TI Garuda Nusantara berkesempatan mengikuti study tour ke Silicon
                                Valley untuk melihat langsung industri teknologi dunia.</p>
                            <a href="artikel-detail.php?id=7" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="teknologi">
                        ...
                        <div class="artikel-content">
                            ...
                            <p>SMK TI Garuda Nusantara menjadi pelopor dalam mengintegrasikan pembelajaran AI dan
                                Machine Learning ke dalam kurikulum untuk mempersiapkan siswa menghadapi era industri
                                4.0.</p>
                            <a href="artikel-detail.php?id=8" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                    ...
                    <article class="artikel-card" data-category="prestasi">
                        <div class="artikel-image">
                            <span class="artikel-category">Prestasi</span>
                            <img src="https://images.unsplash.com/photo-1517245386807-bb43f82c33c4?w=800"
                        ...
                        <div class="artikel-content">
                            ...
                            <p>Tim startup siswa RPL berhasil menjuarai kompetisi startup digital dengan aplikasi
                                inovatif yang mereka kembangkan untuk memecahkan masalah sosial.</p>
                            <a href="artikel-detail.php?id=9" class="artikel-link">Baca Selengkapnya <i
                                    class="fas fa-arrow-right"></i></a>
                        </div>
                    </article>
                </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.addEventListener('click', function (e) {
                if (!filterToggle.contains(e.target) &&
                    !filterButtons.contains(e.target)) {
            ...
            function filterArticles(filters) {
                ...
                articles.forEach(article => {
                    ...
                    const shouldShow = filters.some(filter =>
                        articleCategories.includes(filter)
                    );
