...
--
-- Host: localhost:3306
-- Waktu pembuatan: 27 Okt 2025 pada 04.07
-- Versi server: 8.4.3
-- Versi PHP: 8.3.26
...
(2, 8, 'flu', 'admin', '2025-10-23 07:46:27', 35, 'Izin', NULL, 24, '2025-10-23'),
...
(10, 'Smk ti ', '##sub judul\\r\\nisi', 'tag1, tag2', '68fb4b7d19328.jpg', '2025-10-24 16:48:45', '1');
...
(12, '23', 'Imam ', '$2y$10$9RLTun.b0CVumHKxGyY/0Oz5bckGEDwHdqAn7DDeLII6Iprv1TeIq', NULL, '2025-10-24 08:34:18', 3, 'L', 'cimahi', '021380123', ''),
(13, '120909231', 'pa hasan', '$2y$10$3pKFAu9yfWKkazE.dUfufeMvfdSZojwbVglj1pzt1X.eETq29UUQi', NULL, '2025-10-24 09:28:32', 1, 'L', 'jl. baros', '09123124', '');
...
(6, '23456789', 'nabil', 'laki-laki', 'islam', 'Cimahi', '2006-07-13', 'rouf@gmail.com', '09823714', 'SMPN 16', 'rpl', 'diterima', '2025-10-24 09:46:54'),
(7, '11111111', 'contoh1', 'laki-laki', 'islam', 'Cimahi', '2006-10-18', '', '1234567', 'SMPN 16', 'mp', 'proses', '2025-10-24 09:53:57'),
(8, '11111111', 'contoh2', 'perempuan', 'kristen', 'Cimahi', '2006-12-17', 'rouf@gmail.com', '1234567', 'SMPN 16', 'dkv', 'diterima', '2025-10-24 09:54:19');
...
(35, 'Jessica', 'jeje', '$2y$10$ytWRUMklL6KaB8m1/4zkk.hxgFRDAB3/YkGQ2LR8foX8WaiqTVoTm', 24, '12 DKV 1', NULL, '2025-10-24 16:27:58', 'success', NULL, NULL, NULL),
(36, 'Rouf', 'up', '$2y$10$vyDkDs1K56wvM21GxMtKxuD1k7oKDTSxcytLE/jc6OcAlcp6egXO2', 23, '12 RPL 3', NULL, '2025-10-24 16:49:42', 'success', NULL, NULL, NULL),
(39, 'naafil', 'piu', '$2y$10$8aeilH8qNe04HS9oTaO.ZOf7ulUIx3OwudEpui1nlACjNm33ChL1i', 23, '12 RPL 3', NULL, '2025-10-24 16:51:46', 'success', NULL, NULL, NULL),
(40, 'grace', 'cece', '$2y$10$NBhvZe60Mp3WjxooIR0cqO4F7BSSgGTjVVJNiDYcpTgAl.VWQeX7e', 23, '12 RPL 3', NULL, '2025-10-24 16:34:30', 'success', NULL, NULL, NULL),
...
(42, 'zildanbau', '1', '$2y$10$dUb9Fca./D6by5wbqIf4EOAgfeGhLNfsf4Om4mwByT/dF62H/9fDa', 23, '12 RPL 3', NULL, NULL, NULL, NULL, NULL, NULL);
...
--
ALTER TABLE `absensi`
  MODIFY `absensi_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `siswa`
  MODIFY `siswa_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
